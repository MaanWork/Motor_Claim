...
@Component({
  selector: 'app-total-loss-by-fire',
  templateUrl: './total-loss-by-fire.component.html',
  styleUrls: ['./total-loss-by-fire.component.css']
})
export class TotalLossByFireComponent implements OnInit {
