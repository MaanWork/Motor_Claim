...
@Component({
  selector: 'app-total-loss-by-accident',
  templateUrl: './total-loss-by-accident.component.html',
  styleUrls: ['./total-loss-by-accident.component.css']
})
export class TotalLossByAccidentComponent implements OnInit {
  ...
  @Input() hidebtn: any;
  public LossTypeDes: any = '';VatYN:any="N";
