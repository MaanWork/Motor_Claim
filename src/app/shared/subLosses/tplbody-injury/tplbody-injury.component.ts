...
@Component({
  selector: 'app-tplbody-injury',
  templateUrl: './tplbody-injury.component.html',
  styleUrls: ['./tplbody-injury.component.css']
})
export class TPLBodyInjuryComponent implements OnInit {
  @Input() hidebtn: any;
  ...
  public empYn = 'SelfEmployed';VatYN:any="N";
