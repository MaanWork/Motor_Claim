...
@Component({
  selector: 'app-tplproperty-damage',
  templateUrl: './tplproperty-damage.component.html',
  styleUrls: ['./tplproperty-damage.component.css']
})
export class TPLPropertyDamageComponent implements OnInit {
  @Input() hidebtn: any;
  ...
  public empYn = 'Employee';VatYN:any="";
