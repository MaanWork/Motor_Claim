...
@Component({
  selector: 'app-login-assessor',
  templateUrl: './login-assessor.component.html',
  styleUrls: ['./login-assessor.component.css']
})
export class LoginAssessorComponent implements OnInit {

  public loginMenu: any;
  public branchValue:any="";
  garageForm: FormGroup;
  private formSubmitAttempt: boolean;
  public loginType:any='surveyor';
  loginData: any;
  UserType: any;
  branchList: any[]=[];
  constructor(
