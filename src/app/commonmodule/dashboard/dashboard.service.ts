...
export class DashboardService {
  ...
  async onProcessOfClaims(UrlLink, ReqObj): Promise<Observable<any[]>> {
  ...
  async onQuickSummaryDetails(UrlLink, ReqObj): Promise<Observable<any[]>> {
    let headers = new HttpHeaders();
    headers = headers.append('Authorization', 'Bearer ' + this.getToken());
    return await this.http
      .post<any>(this.ApiUrl + UrlLink, ReqObj, { headers: headers })
  ...
  async onRecentActivityClaims(UrlLink, ReqObj): Promise<Observable<any[]>> {
    let headers = new HttpHeaders();
    headers = headers.append('Authorization', 'Bearer ' + this.getToken());
    return await this.http
      .post<any>(this.ApiUrl + UrlLink, ReqObj, { headers: headers })
